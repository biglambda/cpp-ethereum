...
{
public:
	EthashCUDAHook(Ethash::CUDAMiner* _owner): m_owner(_owner) {}
...
unsigned Ethash::CUDAMiner::s_platformId = 0;
unsigned Ethash::CUDAMiner::s_deviceId = 0;
unsigned Ethash::CUDAMiner::s_numInstances = 0;
...
{
	return ethash_cuda_miner::platform_info(s_platformId, s_deviceId);
}

unsigned Ethash::CUDAMiner::getNumDevices()
{
	return ethash_cuda_miner::get_num_devices(s_platformId);
}
